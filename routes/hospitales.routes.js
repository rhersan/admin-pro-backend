...
const {listaHospitales, crearHospital, actualizarHospital, eliminarHospital, hospitales} = require('../controllers/hospitales.controller');
...
router.get('/select',validarJWT,hospitales);
router.post('/',[
        validarJWT,
